...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param firstString the name of this Silly instance.
     * @param secString the name of this Silly instance.
     */
    public Silly(String firstString, String secString){
        this.name = firstString + secString;
    }
